            ...
            <div class="col-md-12">
              ...
              <div class="box box-solid">
                ...
                <!-- form start -->
                   ...
                   <div class="box-body">
                    <center>
                      <img style="max-width: 300px; margin-top: 50px;" src="{{ URL::to('images/profiles/'.$places->photo) }}" class="img-responsive" alt="blogpost" />
                      <h1>
                          {{ $places->place }}
                      </h1>
                    </center><br>
                    <div class="row m-b">
                      <div class="col-xs-6 text-right">
                        <h4>Location</h4>   
                          <div class="font-bold">
                            <h4 style="color: #9ACD32;">{{ $places->location }}</h4>
                          </div>              
                      </div>
                      <div class="col-xs-6">
                        <h4>Description</h4>
                          <div class="font-bold">
                            <h4 style="color: #9ACD32;">{{ $places->description }}</h4>
                          </div>
                      </div>
                    </div>
