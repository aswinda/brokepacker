            ...
            <div class="col-xs-12">
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <!-- link tambah/create -->
                  <a href="{{ URL::To('admin/districts/create') }}">
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-striped m-b-none display">
                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      @foreach($districts as $key => $kota)      
                      <tr> 
                        <td>
                          <?php echo ++$tmp; ?>
                        </td>
                        <td>
                        <a href="{{ URL::To('admin/districts/show/'.$kota->id) }}">
                          {{ $kota->kota }} 
                        </a>
                        </td>
                        <td>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/districts/delete/'.$kota->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/districts/edit/'.$kota->id) }}">
