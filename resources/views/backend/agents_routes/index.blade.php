            ...
            <div class="col-xs-12">
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <!-- link tambah/create -->
                  <a href="{{ URL::To('admin/agents_routes/create') }}">
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-striped m-b-none display">
                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      @foreach($agents_routes as $key => $route)      
                      <tr> 
                        <td>
                          <?php echo ++$tmp; ?>
                        </td>
                        ...
                        <td>
                        <a href="{{ URL::To('admin/agents_routes/show/'.$route->id) }}">
                          {{ $route->agents }} 
                        </a>
                        </td>
                          <td>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/agents_routes/delete/'.$route->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/agents_routes/edit/'.$route->id) }}">
