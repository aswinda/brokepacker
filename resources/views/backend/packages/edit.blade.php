          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-solid">
                ...
                <!-- form start -->
                <form class="form" role="form" method="POST" action="{{ url('admin/packages/update/'.$packages->id) }}" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                   <div class="box-body">
                    
                    <div class="form-group">
                      <label>Name</label>
                      <input name="name" type="text" class="form-control" placeholder="{{ $packages->name }}" value="{{ $packages->name }}">
                    </div>
