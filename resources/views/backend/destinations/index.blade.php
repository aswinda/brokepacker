                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      ...
                      <tr> 
                        ...
                        <td>
                        <a href="{{ URL::To('admin/destinations/show/'.$place->id) }}">
                          {{ $place->place }} 
                        </a>
                      </td>
                        <td>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/destinations/delete/'.$place->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/destinations/edit/'.$place->id) }}">
