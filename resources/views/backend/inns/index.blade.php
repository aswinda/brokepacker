            ...
            <div class="col-xs-12">
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <!-- link tambah/create -->
                  <a href="{{ URL::To('admin/inns/create') }}">
                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      ...
                      <tr> 
                        ...
                        <td>
                        <a href="{{ URL::To('admin/inns/show/'.$inn->id) }}">
                          {{ $inn->district }} 
                        </a>
                        </td>
                          <td>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/inns/delete/'.$inn->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/inns/edit/'.$inn->id) }}">
