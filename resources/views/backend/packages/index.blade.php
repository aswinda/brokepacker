                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      ...
                      <tr> 
                        ...
                        <td>
                        <a href="{{ URL::To('admin/packages/show/'.$package->id) }}">
                          {{ $package->name }} 
                        </a>
                        </td>
                        <td>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/packages/delete/'.$package->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/packages/edit/'.$package->id) }}">
