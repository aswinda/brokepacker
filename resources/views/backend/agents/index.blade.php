                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      ...
                      <tr> 
                        ...
                        <td>
                        <a href="{{ URL::To('admin/agents/show/'.$agent->id) }}">
                          {{ $agent->name }} 
                        </a>
                        </td>
                        <td>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/agents/delete/'.$agent->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/agents/edit/'.$agent->id) }}">
