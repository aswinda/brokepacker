            ...
            <div class="col-xs-12">
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <!-- link tambah/create -->
                  <a href="{{ URL::To('admin/provinces/create') }}">
                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      ...
                      <tr> 
                        ...
                        <td>
                        <a href="{{ URL::To('admin/provinces/show/'.$prov->id) }}">
                          {{ $prov->name }} 
                        </a>
                        <!-- icon edit -->
                        </td>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/provinces/delete/'.$prov->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/provinces/edit/'.$prov->id) }}">
