        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/provinces') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/provinces') }}">
                <i class="fa fa-leaf"></i> <span>Provinces</span>
              </a>
            </li>

             <li class="{{ Request::is('admin/districts') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/districts') }}">
                <i class="fa fa-leaf"></i> <span>Districts</span>
              </a>
            </li>

            <li class="{{ Request::is('admin/destinations') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/destinations') }}">
                <i class="fa fa-leaf"></i> <span>Destinations</span>
              </a>
            </li>
            <li class="{{ Request::is('admin/agents') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/agents') }}">
                <i class="fa fa-leaf"></i> <span>Agent</span>
              </a>
            </li>
            <li class="{{ Request::is('admin/agents_routes') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/agents_routes') }}">
                <i class="fa fa-leaf"></i> <span>Route</span>
              </a>
            </li>

             <li class="{{ Request::is('admin/inns') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/inns') }}">
                <i class="fa fa-leaf"></i> <span>Inns</span>
              </a>
            </li>
            <li class="{{ Request::is('admin/packages') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/packages') }}">
                <i class="fa fa-leaf"></i> <span>Packages</span>
              </a>
            </li>
             <li class="{{ Request::is('admin/bookings') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/bookings') }}">
                <i class="fa fa-leaf"></i> <span>Bookings</span>
              </a>
            </li>
