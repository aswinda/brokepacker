                    ...
                    <?php $tmp = 0; ?>
                      ...
                      <tr> 
                        <td>
                         ...
                         <td>
                       <a href="{{ URL::To('admin/bookings/show/'.$bookings->id) }}">
                          {{ $bookings->name }} 
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/bookings/delete/'.$bookings->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/bookings/createpackages') }}">
                            <span class="fa-stack fa-lg">
                               <i class="fa fa-circle fa-stack-2x text-default"></i>
                               <i class="fa fa-plus fa-stack-1x text-black"></i>
                            </span>
                          </a>
                           <a href="{{ URL::To('admin/bookings/createuserpackages') }}">
                            <span class="fa-stack fa-lg">
