				...
				<div class="wrap">
					...
					<div class="destination-places-grids">
						...
						<div class="destination-places-grid" onclick="location.href='#';">
							<a href="{{ URL::to('packages/show/'.$package->id ) }}" class="b-link-stripe b-animate-go  thickbox">
								<img class="img-responsive port-pic" src="{{ URL::to('images/profiles/'.$package->photo) }}" />
								<div class="b-wrapper">
							...
							<div class="dest-place-opt">
								<ul class="dest-place-opt-fea">
									...
									<li><a class="plain" href="#"><span> </span> ticket</a></li>
									<li><a class="Breakfast" href="#"><span> </span> Break Fast</a></li>
									<div class="clear"> </div>
								</ul>
								<ul class="dest-place-opt-cast">
									<li><a class="d-place" href="#">{{ $package->name }}</a></li>
									<li><a class="d-price" href="#">Starting Form IDR {{ $package->price }}</a></li>
									<div class="clear"> </div>
								</ul>
							</div>
						</div>
