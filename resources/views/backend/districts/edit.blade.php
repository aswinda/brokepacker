          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-solid">
                ...
                <!-- form start -->
                <form class="form" role="form" method="POST" action="{{ url('admin/districts/update/'.$districts->id) }}" enctype="multipart/form-data">
                   ...
                   <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      @foreach($provinces as $key => $prov)  
                          ...
                          <option <?php if ($prov->id == $districts->province_id) echo "selected" ?> 
                    ...
                    <div class="form-group">
                      <label>Name</label>
                      <input name="name" type="text" class="form-control" placeholder="{{ $districts->kota }}" value="{{ $districts->kota }}">
                    </div>
